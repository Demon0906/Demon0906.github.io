const translations = {
  zh: {
    ...
    heroEyebrow: "Photography Atelier / Slow Looking",
    ...
    projectLabel: "Visual Chapter",
    locationLabel: "地点",
    dateLabel: "时间",
    portraitTitle: "人像摄影",
    portraitIntro: "人物在光线与空间之间短暂停留。",
    natureTitle: "自然风光",
    natureIntro: "植物、海岸与季节里的细微变化。",
    architectureTitle: "人文建筑",
    architectureIntro: "建筑、街区与空间秩序。",
    cityTitle: "城市印象",
    cityIntro: "街道、夜色与建筑片段。",
    dailyTitle: "日常生活",
    dailyIntro: "日常里那些不需要解释的轻盈片刻。",
    travelTitle: "旅游记忆",
  ...
  en: {
    ...
    portraitIntro: "People, emotion, light, and the quiet distance between body and space.",
    natureTitle: "Nature",
    natureIntro: "Plants, coastlines, seasons, and changing weather.",
    architectureTitle: "Architecture",
    architectureIntro: "Architecture, streets, and the order of lived space.",
    cityTitle: "City Impressions",
    cityIntro: "City nights, streets, and architectural fragments from trips.",
    dailyTitle: "Daily Life",
    dailyIntro: "Small records of animals, objects, and nearby ordinary scenes.",
    travelTitle: "Travel",
    travelIntro: "Places, routes, and unexpected encounters kept as a visual diary.",
  ...
  ja: {
    ...
    architectureTitle: "建築の記憶",
    architectureIntro: "建築、街区、暮らしの中にある空間の秩序。",
    cityTitle: "都市印象",
